 ...
 *
 * Disassembly of iASL3DlAgu.aml, Tue Sep 12 14:31:44 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006089 (24713)
 *     Revision         0x02
 *     Checksum         0x1F
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xBA8D6000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xBA8DA000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xBC036B18)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
        ...
        Device (PCI0)
        {
            ...
            Device (GNBD)
            {
                ...
                Device (BROD)
                {
                    ...
                    Name (UMAB, 0x00000003C0000000)
                    Name (UMAM, 0x000000043FFFFFFF)
                ...
                Device (SIO1)
                {
                    ...
                    Method (SIOS, 1, NotSerialized)
                    {
                        ...
                        If ((0x05 != Arg0))
                        {
                            ENFG (0x04)
                            OPT1 = 0xFF
                            OPT2 |= 0x40 /* \_SB_.PCI0.SBRG.SIO1.OPT2 */
                            If (KBFG)
                            {
                                OPT0 |= 0x08
                            }
                    ...
                    Method (SIOW, 1, NotSerialized)
                    {
                        ...
                        OPT1 = 0xFF
                        OPT0 &= 0xE7
                        OPT2 &= 0x0B /* \_SB_.PCI0.SBRG.SIO1.OPT2 */
                        LDN = 0x06
                        ACTR = One
                        LDN = 0x05
                        ACTR = One
    ...
    Scope (_GPE)
    {
        ...
        Method (_L19, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            Notify (\_SB.PCI0.GP17.SHCI, 0x02) // Device Wake
            Notify (\_SB.PWRB, 0x02) // Device Wake
        }
    }
